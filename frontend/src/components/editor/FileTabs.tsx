    ...
    <div className="flex overflow-auto bg-surface border-b border-border shrink-0">
      {paths.map((path) => {
        ...
        return (
          <div
            key={path}
            className={`group flex items-center gap-1.5 px-3 py-1.5 text-[13px] cursor-pointer border-r border-border whitespace-nowrap shrink-0 transition-colors duration-100 ${
              isActive
