...
def render_merge(*, has_data_sources: bool = False) -> str:
    return _env.get_template("merge.jinja2").render(has_data_sources=has_data_sources)


def render_summary() -> str:
    return _env.get_template("summary.jinja2").render()
...
def render_codegen(  # noqa: PLR0913
    *,
    ...
    return _env.get_template("codegen.jinja2").render(
