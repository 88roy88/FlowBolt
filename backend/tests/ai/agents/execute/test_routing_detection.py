...
class TestDetectUsesRouting:
    def test_keyword_heuristic_navigation(self) -> None:
        assert detect_uses_routing("Build an app with a navbar and about page", {"tasks": []})

    def test_keyword_heuristic_multi_page(self) -> None:
        assert detect_uses_routing("I want a multi-page site", {"tasks": []})
