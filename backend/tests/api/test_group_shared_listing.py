...
class TestGroupSharedListingEndpoint:
    async def test_group_shared_project_appears_in_list(self, test_db, async_client):
    ...
    async def test_non_matching_group_omits_group_shared_projects(self, test_db, async_client):
    ...
    async def test_direct_and_group_share_collapse_to_highest_role(self, test_db, async_client):
